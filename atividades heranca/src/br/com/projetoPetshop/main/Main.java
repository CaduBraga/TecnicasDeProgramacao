package br.com.projetoPetshop.main;

import java.util.Scanner;
import br.com.projetoPetshop.service.CadastroService;

public class Main {
    public static void main(String[] args) {
        System.out.println("=== Sistema de Cadastro do Petshop ===");
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    cadastro.cadastrarDono();
                    break;
                case 2:
                    cadastro.cadastrarVeterinario();
                    break;
                case 3:
