...
import br.com.appCursos.service.exceptions.*;
...
public class ValidacaoService {
    ...
    public static int validarCargaHoraria(Scanner input, String mensagem) throws EntradaInvalidaException {
        int cargaHoraria = validarInteiro(input, mensagem);
        if (cargaHoraria <= 0) {
            throw new EntradaInvalidaException("Carga horária deve ser maior que zero!");
        }
        return cargaHoraria;
    }
}
