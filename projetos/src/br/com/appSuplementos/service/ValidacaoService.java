...
import br.com.appSuplementos.service.exceptions.*;
...
public class ValidacaoService {
    ...
    public static double validarPeso(Scanner input, String mensagem) throws EntradaInvalidaException {
        double peso = validarDouble(input, mensagem);
        if (peso <= 0) {
            throw new EntradaInvalidaException("Peso deve ser maior que zero!");
        }
        return peso;
    }
}
