...
import br.com.appFilmes.service.exceptions.*;
...
public class ValidacaoService {
    ...
    public static int validarDuracao(Scanner input, String mensagem) throws EntradaInvalidaException {
        int duracao = validarInteiro(input, mensagem);
        if (duracao <= 0) {
            throw new EntradaInvalidaException("Duração deve ser maior que zero!");
        }
        return duracao;
    }
}
